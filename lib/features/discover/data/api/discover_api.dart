...
class DiscoverApi {
  ...
  Future<Map<String, dynamic>> getRecommendedMoviesFromApi(
    ...
    try {
      final Response response = await dioClient
          .get('${Endpoints.baseUrl}/movie/$movieId/recommendations');
      return response.data;
    } catch (e) {
      rethrow;
    }
  ...
  Future<Map<String, dynamic>> getMovieTrailerIdFromApi(
      {required int movieId}) async {
    try {
      final Response response =
          await dioClient.get('${Endpoints.baseUrl}/movie/$movieId/videos');
      return response.data;
    } catch (e) {
      rethrow;
    }
