...
// The DiscoverStore class is responsible for managing the state and actions related to the discover feature.
class DiscoverStore = _DiscoverStore with _$DiscoverStore;

// The _DiscoverStore class is the implementation of the DiscoverStore class.
abstract class _DiscoverStore with Store {
  ...
  // Fetches the movies from the API and updates the discoverMovieModel.
  // If network is not available, it fetches the movies from the local database.
  @action
  ...
  // Fetches the next page of movies from the API and appends it to the current discoverMovieModel.
  @action
  ...
  // Fetches the movies from the local database and updates the discoverMovieModel.
  ...
  // Inserts the movies from the discoverMovieModel into the local database.
  ...
  // Fetches the details of a movie using its ID.
  @action
  ...
  // If network is not available, it filters the movies from the local database based on the query.
  @action
  ...
  // Gets the trailer ID of a movie using its ID.
  ...
  // Toggles the layout between grid view and list view.
  @action
  void updateLayout() {
