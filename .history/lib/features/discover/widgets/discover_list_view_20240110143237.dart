  ...
  void initState() {
    scrollController.addListener(() {
      if (scrollController.position.pixels ==
        ...
        discoverStore.isLoadingMoreMovies = true;
        discoverStore.loadMoreMovies().then((value) {
        ...
        return Column(
          children: [
            ...
            Observer(builder: (context) {
              return Visibility(
                visible: discoverStore.isLoadingMoreMovies &&
                    index ==
                        (discoverStore.discoverMovieModel.results?.length ??
                                1) -
                            1,
                child: const Center(
